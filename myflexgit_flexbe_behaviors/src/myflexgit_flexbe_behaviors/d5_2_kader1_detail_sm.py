...
@author: Rok Pahic
'''
class D5_2_kader1_detailSM(Behavior):
	'''
	...
	def __init__(self):
		super(D5_2_kader1_detailSM, self).__init__()
		self.name = 'D5_2_kader1_detail'
	...
	def create(self):
		...
		# x:30 y:365, x:130 y:365
		_sm_group_3 = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['TR', 'FA'])
